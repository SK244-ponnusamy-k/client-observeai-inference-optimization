...
#
# Usage:
#   bash vllm/models/gpt-oss-20b/deploy.sh                     # defaults (model.env)
#   bash vllm/models/gpt-oss-20b/deploy.sh --hw g5.2xlarge     # pin GPU family/size
#   bash vllm/models/gpt-oss-20b/deploy.sh --hw g6.2xlarge --validate
# ==============================================================================
