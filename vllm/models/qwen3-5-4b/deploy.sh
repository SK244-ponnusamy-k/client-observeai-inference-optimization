#!/bin/bash
# ==============================================================================
# vllm/models/qwen3-5-4b/deploy.sh  - GENERATED by `oai model generate qwen3-5-4b`
#
# Generic deploy - model-specific names come from model.env.
# Usually you run this via the friendly wrapper:  oai deploy qwen3-5-4b
...
#   bash vllm/models/qwen3-5-4b/deploy.sh --validate       # smoke-test after ready
# ==============================================================================
...
echo ""
echo "=================================================="
echo "  DEPLOYING - Qwen/Qwen3.5-4B"
...
if ! aws s3 ls "s3://${MODEL_BUCKET}/${MODEL_FOLDER}/" --region "${AWS_REGION}" >/dev/null 2>&1; then
    ...
    log_error "Download it first: oai download qwen3-5-4b   (or bash model-download/qwen3-5-4b/download.sh)"
    exit 1
fi
...
echo ""
echo "=================================================="
echo "  DEPLOY RESULT - qwen3-5-4b on ${NODE_INSTANCE_TYPE}  (ready=${DEPLOY_READY})"
echo "=================================================="
