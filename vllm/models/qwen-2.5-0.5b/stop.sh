...
#
# Stops ONLY the qwen-2.5-0.5b deployment and its resources.
# Other running models (e.g. gpt-oss-20b) are NOT affected.
...
#   kubectl apply -f vllm/models/qwen-2.5-0.5b/service/service-private.yaml
#
...
SERVICE_NAME="vllm-qwen-0.5b"
PVC_NAME="metadata-cache-qwen-0.5b"

echo ""
echo "══════════════════════════════════════════════════"
echo "  STOP — qwen-2.5-0.5b"
