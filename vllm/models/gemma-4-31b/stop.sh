#!/bin/bash
# ==============================================================================
# vllm/models/gemma-4-31b/stop.sh
#
...
#   - Other model deployments (qwen-2.5-0.5b, gpt-oss-20b, qwen3-35b-nvfp4)
#
# Usage:
#   cd llm-inference-framework
#   bash vllm/models/gemma-4-31b/stop.sh
# ==============================================================================
...
echo "    • Terminate GPU node (g6e.12xlarge, 4x L40S — stops billing ~\$10.49/hr)"
